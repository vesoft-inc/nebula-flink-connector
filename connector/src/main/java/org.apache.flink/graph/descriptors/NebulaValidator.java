...
public class NebulaValidator extends ConnectorDescriptorValidator {
    ...
    public static final String CONNECTOR_READ_PARTITION_LOWER_BOUND = "connector.read.partition"
            + ".lower-bound";
    public static final String CONNECTOR_READ_PARTITION_UPPER_BOUND = "connector.read.partition"
            + ".upper-bound";
    ...
    private void validateReadProperties(DescriptorProperties properties) {
        ...
        checkAllOrNone(properties, new String[]{CONNECTOR_READ_PARTITION_COLUMN,
            CONNECTOR_READ_PARTITION_LOWER_BOUND, CONNECTOR_READ_PARTITION_UPPER_BOUND,
    ...
    private void validateLookupProperties(DescriptorProperties properties) {
        ...
        checkAllOrNone(properties, new String[]{CONNECTOR_LOOKUP_CACHE_MAX_ROWS,
